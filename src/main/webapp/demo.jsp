...
<html>
	...
	<title>Apply Leave</title>
			...
			<script>
				$( function() 
				{
	    			...
	    			$("#datepicer").datepicker({ minDate: 0});
	  				} );
			</script>
	...
	<body>
		...
		<form name = "leaveform" action = "LeaveformServlet" onsubmit="return validateForm()">
			<label for="fdate">From_Date</label>
			<input type="text" id="datepicker" name="fromdate" placeholder="Select from date">
			<label for="fdate">To_Date</label>
			<input type="text" id="datepicer" name="todate" placeholder="Select to date" >
			<label for="Reason">Reason</label>
			<input type = "text"  id="reason" name="Reason" placeholder="Enter the reason" >
