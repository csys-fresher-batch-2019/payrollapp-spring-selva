			...
			<div class = "container">
				...
				<div class="uyt">
					<form action = "PFcalcServlet">
						...
						<button type = "submit" value = "Calculate Increment" formaction = "IncrementCalcSalary">Calculate Increment</button>
						<button type = "submit" value = "Mark Attendance" formaction = "AttendanceServlet">Mark Attendance</button>
						<button type = "submit" value = "Calculate Salary" formaction = "SalaryCalcServlet" >Calculate Salary</button>
						<button type = "submit" value = "Generate Payslip" formaction = "PayslipServlet" >Generate Payslip</button>
					</form>
