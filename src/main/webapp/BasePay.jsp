...
<html>
	...
	<body>
		<form action = "AddbasePayServlet" name = "details" onsubmit="return validate()">
			<label for="Reason">ID</label>
			<input type = "text" name = "id" placeholder = "Enter the Id" min="1000"  maxlength="4" required autofocus />
			<label for="Reason">Base Salary</label>
			<input type = "text" name = "pay" placeholder = "Enter the basepay" min="10000"  maxlength="7" required autofocus />
